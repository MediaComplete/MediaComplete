...
namespace MSOE.MediaComplete.Test.Background
{
    ...
    public class ImportTaskTest
    {
        ...
        public void Test_AddImportEmptyQueue_Added()
        {
            ...
            var subject = new ImportTask(FileManager.Instance, null, null, false);
        ...
        public void Test_AddImport_GoesBeforeSortAndIdentify()
        {
            var queue = new List<List<Task>>
            {
                ...
                new List<Task> {new IdentifierTask(), new SortingTask(null)},
                new List<Task>()
            };
            ...
            Assert.IsInstanceOfType(queue[1][0], typeof(SortingTask), "Stage 2 doesn't have an SortingTask!");
            ...
            Assert.IsInstanceOfType(queue[3][1], typeof(SortingTask), "Stage 4 task 2 isn't an ImportTask!");
        ...
        public void Test_AddImport_GoesWithOtherImport()
        {
            var queue = new List<List<Task>>
            {
                new List<Task> {new ImportTask(FileManager.Instance, null, null, false)},
                new List<Task> {new IdentifierTask(), new IdentifierTask()}
            };
            ...
            Assert.IsInstanceOfType(queue[0][0], typeof(ImportTask), "Stage 1 doesn't have the old import task!");
